...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
        <div style="width:25%;">
            <%-- Label and Input for receiving Product Name value --%>
            ...
            <%-- Label and Input for product category --%>
            <div class="form-group">
            ...
            <%-- Label and Input for product price --%>
            <div class="form-group">
            ...
            <%-- Label and Input for product production date --%>
            <div class="form-group">
            ...
            <%-- Label and Input for image for the product --%>
            <div class="form-group">
